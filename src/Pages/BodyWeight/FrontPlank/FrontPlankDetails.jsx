...
import FrontPlankVideo from "./FrontPlankVideo";
import AutoScroll from "./AutoScroll";

const  FrontPlankDetails = () => { 
  return(
    <Layout>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <div className="-mt-2 md:-mt-2 lg:-mt-[13rem] dark:text-fontColor">
              ...
              <p className="mx-2 mt-2">The front plank, often simply referred to as the plank, is a core exercise designed to improve strength and stability throughout the body. </p>
            </div>
          </div>
          <div>
...
export default FrontPlankDetails
